  ...
  return (
    ...
    <div className=' flex mt-10'>
          <div className='ml-20 mt-56 absolute'>
            ...
            <a href="#new"><button className=' mt-20 flex border-2 border-violet-500 hover:bg-gradient-to-r from-violet-600 to-purple-700 pr-4 text-white text-2xl font-bold py-2 px-4'>¡Vamos a ello!</button></a>
            </div>
            <div className='ml-96 '>
            <div className='ml-64 '>
