  ...
  return (
    <nav className='' >
        ...
        <div className='container m-auto text-black flex '>
            ...
            <div>
            <button onClick={handleReset} className='mt-8 mr-20 pl-4 pr-4 pt-1 pb-1 rounded-lg bg-gradient-to-r from-violet-600 to-purple-700 text-white font-semibold'><Link to="/">Sign off</Link></button>
            </div>
            ...
            <button className='block md:hidden py-3 px-4 mx-2 rounded focus:outline-none hover:bg-gray-200 group'>
                ...
                <div className='absolute top-0 z-30 -right-full h-screen w-8/12 bg-white boder opacity-0 group-focus:right-0 group-focus:opacity-100 transition-all duration-300'>
                    <ul className='flex flex-col items-center w-full text-base cursor-pointer pt-10'>
                        <li className='hover:bg-gray-200 py-4 px-6 w-full'><Link to="/listado">Home</Link></li>
                        <li className='hover:bg-gray-200 py-4 px-6 w-full'><Link to="/favorites">Favorites</Link></li>
                    </ul>
